...
const Footer = () => {
  return <footer className="bg-white border-t border-knude-200">
      <div className="bg-knude-50 py-6 text-center">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4">
            <input type="email" placeholder="Your email address" className="px-4 py-2 border border-knude-300 rounded-md focus:outline-none focus:ring-2 focus:ring-knude-500 max-w-xs w-full" />
